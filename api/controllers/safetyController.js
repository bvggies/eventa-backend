...
exports.getLiveSafetyFeed = exports.getSafetyStatistics = exports.acknowledgeSafetyAlert = exports.getUnacknowledgedEmergencies = exports.getAllSafetyAlerts = exports.getMySafetyHistory = exports.checkIn = exports.markSafe = exports.reportEmergency = exports.shareLocation = void 0;
...
const shareLocation = async (req, res) => {
    try {
        ...
        const result = await database_1.pool.query(`INSERT INTO safety_checks (
...
const reportEmergency = async (req, res) => {
    try {
      ...
      RETURNING *`, [
        ...
        if (sosBroadcast) {
            try {
                const contacts = await database_1.pool.query('SELECT * FROM trusted_contacts WHERE user_id = $1 AND can_receive_sos = TRUE', [req.userId]);
...
const getMySafetyHistory = async (req, res) => {
    try {
        const result = await database_1.pool.query(`SELECT * FROM safety_checks 
       WHERE user_id = $1 
...
exports.getMySafetyHistory = getMySafetyHistory;
// Admin: Get all safety alerts
const getAllSafetyAlerts = async (req, res) => {
    try {
...
exports.getAllSafetyAlerts = getAllSafetyAlerts;
// Admin: Get unacknowledged emergencies
const getUnacknowledgedEmergencies = async (req, res) => {
    try {
...
exports.getUnacknowledgedEmergencies = getUnacknowledgedEmergencies;
// Admin: Acknowledge safety alert
const acknowledgeSafetyAlert = async (req, res) => {
    try {
        const { id } = req.params;
        const result = await database_1.pool.query(`UPDATE safety_checks 
...
exports.acknowledgeSafetyAlert = acknowledgeSafetyAlert;
// Admin: Get safety statistics
const getSafetyStatistics = async (req, res) => {
    try {
...
exports.getSafetyStatistics = getSafetyStatistics;
// Admin: Get live safety feed
const getLiveSafetyFeed = async (req, res) => {
    try {
...
exports.getLiveSafetyFeed = getLiveSafetyFeed;
