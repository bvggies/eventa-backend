      ...
      if (existing.rows.length > 0) {
        ...
        await client.query(
          `UPDATE users 
           ...
           WHERE email = $6`,
          [admin.name, admin.password, admin.phone, admin.is_organizer, admin.is_admin, admin.email]
        );
        ...
        const result = await client.query(
          ...
          [admin.name, admin.email, admin.password, admin.phone, admin.is_organizer, admin.is_admin]
        );
